...
-- Drop existing tables if they exist (since database is empty)
...
-- Create admin_actions table (optional, for tracking)
...
-- Create system_settings table (optional, for configuration)
...
-- Create move_buffer table (optional, for batching)
