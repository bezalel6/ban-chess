...
import { generateTestUsername, clearStorageAndCookies, waitForToast } from './utils/test-helpers';
...
test.describe('Authentication', () => {
  ...
  test('should show error for duplicate username', async ({ page, authPage }) => {
    ...
    await newPage.goto('/');
    const secondAuthPage = new (await import('./fixtures/auth-page')).AuthPage(newPage);
  ...
  test('should persist username across page reloads', async ({ page, authPage }) => {
